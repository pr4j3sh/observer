# Observer — Roadmap & Product Spec

This file is the product spec and phased roadmap for Observer. `AGENTS.md` summarizes the phases and the working rules; this file holds the detail.
